<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CBTT_DaiHoiDongCDTN.ascx.cs" Inherits="Web3Tier.ASCX.CBTT_DaiHoiDongCDTN" %>
                ...
                <table cellpadding="0" cellspacing="0">
                    <tr align="left">
                        <td class="auto-style1">
                            Đại hội đồng cổ đông thường niên</td>
