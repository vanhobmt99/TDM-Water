                ...
                <table cellpadding="0" cellspacing="0">
                    <tr align="left">
                        <td class="tieude-bantinchitiet">
                            ...
                            <a href="../ASPX/Banlanhdao.aspx">Ban lãnh đạo</a>
                        </td>
                                ...
                                <tr>
                                    <td>
                                        <table cellpadding="0" cellspacing="0" align="center">
                                            <tr>
                                                <td align="center" colspan="5" style="font-family: arial; font-size: 20px; line-height: 160%; color: #006dd2; padding-top: 10px; padding-bottom: 10px; font-weight: bold">BAN LÃNH ĐẠO CÔNG TY CỔ PHẦN NƯỚC THỦ DẦU MỘT</td>
                                            </tr>
                                            <tr>
                                                <td align="center">
                                                    <img src="../hinh/nguyenvantri.png" />
													<p style="color: Black; line-height: 150%; margin-top: 8px; margin-bottom: 10px; font-size: 14px">
                                                        <b>Ông Nguyễn Văn Trí</b>
                                                        <br />
