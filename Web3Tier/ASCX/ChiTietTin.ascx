<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChiTietTin.ascx.cs" Inherits="Web3Tier.ASCX.ChiTietTin" %>
...
<table cellpadding="0" cellspacing="0" style="background-color: #FFFFFF; width: 100%;">
    <tr>
        <td style="vertical-align: top; width: 220px; table-layout: fixed; padding-left: 5px;">
            <%-- Cột Trái --%>
            <table cellpadding="0" cellspacing="0" style="vertical-align: top; margin-bottom: 5px;">
                <tr>
                    <td>
                                            ...
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td style="width: 50px; height: 50px;">
                                                        <img id="imgSrcVanBan" runat="server" /></td>
            ...
            <table cellpadding="0" cellspacing="0">
                <tr align="left">
                        <td class="tieude-bantinchitiet">
                            <a id="tintucsukien" runat="server"  href="#" style="color: white !important"> </a>
                            <div id="TieuDe" runat="server" class="auto-style1">Tin tức hoạt động 1</div>
                        </td>
                    ...
                    <tr>
                        <td colspan="2">
                            <table cellpadding="0" cellspacing="0" class="khungtin">
                                <tr>
                                    <td>
                                        <asp:Label ID="lbTieuDe" runat="server" CssClass="tieudeTinchitiet"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="lbNgayDang" runat="server" CssClass="ngaydangtin"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="lbNoiDung" runat="server" CssClass="noidungTinchitiet"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
