<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TinChatLuongNuoc.ascx.cs" Inherits="Web3Tier.ASCX.TinChatLuongNuoc" %>
                ...
                <table cellpadding="0" cellspacing="0">
                    <tr align="left">
                        <td class="tieude-bantinchitiet">
                            <a href="../ASPX/Thongbao.aspx">Kết quả xét nghiệm nước</a>
                        </td>
